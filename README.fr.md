...
| `just process MODE FORMAT PATH` | Pipeline automatique. MODE : `deepsky`·`nebula`·`milkyway`·`planetary`·`comet`·`sun` ; FORMAT : `image`·`video`·`both`. Options après le chemin (ex. `-v --supervise`). |
