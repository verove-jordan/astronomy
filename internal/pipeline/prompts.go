...
- core_highlight_knee/ceil (0..1, knee<ceil): rolls off a blown nebula core.
- ha_exclude_stars (bool): screen Ha onto nebulosity only.
...
const defectVocabulary = `background_cast_green, background_cast_magenta, background_too_bright, background_too_dark, shadows_crushed, highlights_blown, core_blown, oversaturated, undersaturated, chroma_noise, luminance_noise, gradient, stars_bloated, stars_dominant, insufficient_integration, trail_residue, halo_artifacts, edge_artifacts`
